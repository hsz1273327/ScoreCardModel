...
import numpy as np
from score_card_model.utils.check import check_array_binary, check__array_continuous
...
class TestCheckArrayContinuous(TestCase):
    ...
    def test_int(self):
        self.assertFalse(check__array_continuous(self.x))
    def test_str(self):
        self.assertFalse(check__array_continuous(self.y))

    def test_bool(self):
        self.assertFalse(check__array_continuous(self.z))
    def test_float(self):
        self.assertTrue(check__array_continuous(self.m))
